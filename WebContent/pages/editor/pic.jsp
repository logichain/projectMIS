...
<form name="uploadForm" action="/freshmen/uploadAction.do?method=picUpload" enctype="multipart/form-data" method="post">  
<table align=center>
<tr><td>图片地址：<input type="file" name="theFile" id=a  size=35></td></tr><tr>
          <td> 说明文字：
...
图片位置：<select  name ="h" id=h><option>默认位置<option value="left">居左<option value="right" >居右
...
图片宽度：<input name ="d" id=d  ONKEYPRESS="event.returnValue=IsDigit();" value="200" size=4 maxlength="4">图片高度：<input name ="e" id=e ONKEYPRESS="event.returnValue=IsDigit();"  value="200" size=4 maxlength="4"></td></tr><tr><td>上下间距：<input name ="f" id=f  ONKEYPRESS="event.returnValue=IsDigit();" value="0" size=4 maxlength="2">左右间距：<input name ="g" id=g ONKEYPRESS="event.returnValue=IsDigit();"  value="0" size=4 maxlength="2">
</td></tr></table>
</form>
</jodd:form>
