...
<html:form action="projectManage.do" enctype="multipart/form-data" onsubmit="return checkFormValidate();" >
	...
	<table class="win" CELLPADDING="0" CELLSPACING="0" WIDTH="90%" border="0">
		...
		<tr>
			...
			<td id="filetd">
				<html:file styleId="attachmentFile" property="projectInfo.currentAttachment.attachmentFile" size="50"  onchange="document.getElementById('projectInfo.currentAttachment.paLocalUrl').value=this.value"></html:file>	
