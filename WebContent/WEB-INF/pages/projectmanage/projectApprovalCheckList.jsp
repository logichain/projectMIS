...
<center>
	...
	<gui:window title="<%=title%>" prototype="boWindow" color="100%">			
		<html:form action="projectManage.do">
			<html:errors />
			<input type="hidden" name="method" value="searchProjectApprovalCheck">
...
<%-- 						</logic:equal> --%>
					...
					<td align="right">
						...
						<html:submit styleClass="resetbutton" onclick="chgAction(document.all.method,'resetSearchProjectApprovalCheck');">
							&nbsp;
						</html:submit>
					</td>
				</tr>
			...
			<table class="sort-table" cellSpacing="1" cellPadding="1" width="100%" border="0">						
				...
				<tbody>
					...
					<pg:pager url="./projectManage.do" items="<%=Integer.valueOf(itemNo.toString())%>" index="center" maxPageItems="<%=Integer.valueOf(pageCount.toString())%>" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
						...
						<pg:param name="method" value="searchProjectApprovalCheck"/>
							...
							<pg:item>
							  <tr>
								...
								<logic:equal name="a" value="1"><tr class="odd"></logic:equal>
									...
									<logic:equal name="accountPerson" property="hasCreatePower" value="true">
										<td align="center">											
											<logic:equal name="tp" property="parStatus" value="3">
												<a href='projectManage.do?method=editProjectApprovalCheck&id=<bean:write name="tp" property="parId"/>'><img border="0" src="pages\images\icon\16x16\modify.gif"></a>
											</logic:equal>											
										</td>
