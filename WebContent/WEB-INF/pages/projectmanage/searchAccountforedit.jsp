		...
		<html:form action="projectManage.do">
			...
			<table class="sort-table" cellSpacing="1" cellPadding="1" width="100%" border="1">						
				...
				<logic:present name="accountList" scope="request">
					...
					<pg:pager url="./projectManage.do" items="<%=itemNo%>" index="center" maxPageItems="10" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
