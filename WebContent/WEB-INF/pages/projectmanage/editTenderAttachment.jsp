...
<html:form action="tenderProjectManage.do" enctype="multipart/form-data" onsubmit="return checkFormValidate();">
	...
	<table class="win" CELLPADDING="0" CELLSPACING="0" WIDTH="90%" border="0">
		...
		<tr>
			...
			<td >
				<bean:write name="tenderProjectForm" property="tenderInfo.currentTenderAttachment.taLocalUrl"/>
			</td>
		</tr>
		<tr>
			<td width="10%" align="right">
			...
			<td  id="filetd">
				<html:file property="tenderInfo.currentTenderAttachment.attachmentFile" size="50"  onchange="document.getElementById('tenderInfo.currentTenderAttachment.taLocalUrl').value=this.value">					
				</html:file>	
