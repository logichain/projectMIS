		...
		<tr><td align="left">
			...
			<td align="center" width="12%">
				<logic:equal name="accountPerson" property="hasCreatePower" value="true">	
					<html:button styleClass="addbutton" property="" onclick="openDialog('projectManage.do?method=addProjectAttachment',500,180);">
						&nbsp;
					</html:button>	
				...
				<logic:notEqual name="pa" property="paFlag" value="-1">
					...
					<logic:equal name="a" value="1"><tr class="odd"></logic:equal>
						...
						<logic:empty name="pa" property="paId">
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td align="center"><a href='projectManage.do?method=deleteProjectAttachmentByIndex&index=<%=i %>'><img border="0" src="pages\images\icon\16x16\delete.gif"></a></td>
						</logic:empty>
						<logic:notEmpty name="pa" property="paId">
							...
							<td align="center">
								<logic:equal name="accountPerson" property="hasCreatePower" value="true">
									<a href='javascript:openDialog("projectManage.do?method=editProjectAttachment&id=<bean:write name="pa" property="paId"/>",500,200);'><img border="0" src="pages\images\icon\16x16\modify.gif"></a>
								</logic:equal>
							</td>
							<td align="center">
								<logic:equal name="accountPerson" property="hasCreatePower" value="true">
									<a href='javascript:if(confirm("确认要删除这条信息吗?")) {chgAction(document.all.id,"<bean:write name="pa" property="paId"/>");chgAction(document.all.method,"deleteProjectAttachment");projectSearchForm.submit();}'><img border="0" src="pages\images\icon\16x16\delete.gif"></a>
								</logic:equal>
							</td>
						</logic:notEmpty>
					</tr>
