			...
			<table class="win" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" border="0">
				...
				<tr><td colspan="2">&nbsp;</td><td colspan="2"> 
					<table class="sort-table" width="100%">
						...
						<logic:iterate id="up" name="accountForm" property="account.usrPostList" indexId="i">	
						<tr>
							<td>
								<html:select  property="account.usrPostList[${i}].dept" style="width:120">	
									<html:option value=""></html:option>
									<html:options collection="departmentList" property="DId" labelProperty="DName"/>
								</html:select>
							</td>							
							<td>
								<html:select  property="account.usrPostList[${i}].post" style="width:120">	
									<html:option value=""></html:option>
