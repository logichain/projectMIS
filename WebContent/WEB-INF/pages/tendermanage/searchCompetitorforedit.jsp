...
<center>
	...
	<gui:window title="<%=title%>" prototype="boWindow" color="100%">			
		<html:form action="tenderProjectManage.do">
			<input type="hidden" name="method" value="confirmCompetitor">
			...
			<table class="win" CELLPADDING="2" CELLSPACING="0" width="100%">					
				<tr align="right">
					<td>						
						...
						<html:submit styleClass="searchbutton" onclick="chgAction(document.all.method,'searchCompetitor');initPageNo();">
							&nbsp;
						</html:submit>
						<html:submit styleClass="resetbutton" onclick="chgAction(document.all.method,'resetSearchCompetitor');">
							&nbsp;
						</html:submit>
					</td>
				</tr>
			...
			<table class="sort-table" cellSpacing="1" cellPadding="1" width="100%" border="0">						
				...
				<thead>
					...
					<pg:pager url="./tenderProjectManage.do" items="<%=itemNo%>" index="center" maxPageItems="10" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
						...
						<pg:param name="method" value="searchCompetitor"/>
