	...
	<html:form action="tenderProjectManage.do" enctype="multipart/form-data" onsubmit="return checkFormValidate();">
		...
		<table class="win" CELLPADDING="0" CELLSPACING="0" WIDTH="90%" border="0">
			...
			<tr>
				...
				<td >
					<html:file styleId="file" property="tenderInfo.currentAttachment.attachmentFile" size="50"  onchange="document.getElementById('tenderInfo.currentAttachment.paLocalUrl').value=this.value"></html:file>	
			...
			<tr>
				...
				<td width="15%">						
					<html:text styleId="fileCode" property="tenderInfo.currentAttachment.paCode" size="12" maxlength="45" readonly="true" style="background-color:LightGray;"/>
				</td>
			</tr>
			<tr>
				<td width="10%" align="right">
				...
				<td width="15%">						
					<html:text styleId="fileName" property="tenderInfo.currentAttachment.paName" size="45" maxlength="45"/>
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
