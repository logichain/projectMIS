			...
			<table class="sort-table" cellSpacing="1" cellPadding="1" width="100%" border="0">			
				<thead>
					...
					<pg:pager url="./customerManage.do" items="<%=itemNo%>" index="center" maxPageItems="<%=Integer.valueOf(pageCount.toString())%>" maxIndexPages="10" isOffset="<%= true %>" export="offset,currentPageNumber=pageNumber" scope="request">
						...
						<pg:param name="method" value="searchCustomer"/>
							...
							<pg:item>
							  <tr>
								...
								<logic:equal name="a" value="1"><tr class="odd"></logic:equal>
									...
									<logic:equal name="accountPerson" property="hasCreatePower" value="true">
										<td align="center">
											<logic:equal name="customer" property="CFlag" value="0">
												<a href='customerManage.do?method=modifyCustomer&id=<bean:write name="customer" property="CId"/>'><img border="0" src="pages\images\icon\16x16\modify.gif"></a>
											</logic:equal>
										</td>	
										<td align="center">
											<logic:equal name="customer" property="CFlag" value="0">
												<a href='javascript:if(confirm("确认要删除这条信息吗?")) {chgAction(document.all.id,"<bean:write name="customer" property="CId"/>");chgAction(document.all.method,"deleteCustomer");customerForm.submit();}'><img border="0" src="pages\images\icon\16x16\delete.gif"></a>
											</logic:equal>	
										</td>
										<logic:equal name="accountPerson" property="projectManageSecretary" value="true">
											<td align="center">											
												<logic:equal name="customer" property="CFlag" value="0">
													<a href='customerManage.do?method=checkCustomer&id=<bean:write name="customer" property="CId"/>'><img border="0" src="pages\images\icon\16x16\order.gif"></a>
												</logic:equal>											
											</td>
										</logic:equal>	
									</logic:equal>
									<logic:equal name="accountPerson" property="id" value="0">
										<td align="center">
											<logic:equal name="customer" property="CFlag" value="-1">
												<a href='customerManage.do?method=cancelDeletedCustomer&id=<bean:write name="customer" property="CId"/>'><img border="0" src="pages\images\icon\16x16\return.gif"></a>
											</logic:equal>
										</td>	
									</logic:equal>
								</tr>
