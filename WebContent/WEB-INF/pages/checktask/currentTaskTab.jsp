...
<html:form action="projectManage.do">
	...
	<table class="win" CELLPADDING="2" CELLSPACING="0" width="100%" border="0">	
		...
		<tr>
			...
			<td>
				<html:select property="checkTaskInfo.sendUser.person.dept" style="width:120">	
					<html:option value=""></html:option>
...
<%-- 								<logic:notEqual name="accountPerson" property="hasCreatePower" value="true"> --%>
									<a href='javascript:openDialog("projectManage.do?method=doCheckTask&id=<bean:write name="task" property="ctId"/>",800,400);'><img border="0" src="pages\images\icon\16x16\authority.gif"></a>
<%-- 								</logic:notEqual> --%>
							</td>
						</logic:notEqual>	
					</tr>
