...
public class SecurityAction extends BaseAction {
	...
	public ActionForward login(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (account == null || account.getFlag().equals(CommonService.DELETE_FLAG) || account.getEnabled().equals("0")) 
		{			
			errors.add("User login", new ActionMessage("errors.LoginError"));
		}
		...
		if ((destinatedUrl != null) && (destinatedUrl.length() > 0)) {
			...
			String welcomeStr = account.getPerson().getPersonName() + "  ";	
			
			for(UsrPost up:account.getUsrPostList())
			{
				if(up.getDept() != null && up.getPost() != null)
				{
					welcomeStr = welcomeStr + up.getDeptObject().getDName() + "/" + up.getPostObject().getPName() + "、";
				}				
			}
			
			if(welcomeStr.contains("、"))
			{
				welcomeStr = welcomeStr.substring(0, welcomeStr.length() -1);
			}
			
			welcomeStr = welcomeStr + "，您好!";

			request.getSession().setAttribute("selfJobInfo", welcomeStr);
	 ...
	 * @throws Exception
	 */
	public ActionForward getUserMenu(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		{
			menuTree.addAll(securityService.getDeptMenus(null));
		}
		else if(!account.haveNoAnyPost())
		{
			for(UsrPost up:account.getUsrPostList())
			{
				if(up.getDept() != null && up.getPost() != null)
				{
					List list = securityService.getDeptMenus(up.getDept());
					if(up.getPost().equals(Post.POST_GENERAL_USER))
					{
						for(Object o:list)
						{
							Menu m = (Menu)o;
							if(!menuTree.contains(m) && (m.getTarget() == null || m.getBasicMenu() != null))
							{
								menuTree.add(m);
							}
						}	
		...
		Collections.sort(menuTree, new Comparator<Menu>(){
			...
			public int compare(Menu m1, Menu m2) {
				...
				return m1.getSortFlag().compareTo(m2.getSortFlag());
			}});
	...
	public ActionForward searchAccount(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Account accountInfo = (Account) dform.get("accountInfo");
		
		Object[] args = { accountInfo, page,user};
	...
	public ActionForward resetSearchAccount(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
			log.debug("Entering 'securityAction->listAccount' method");
		}
		DynaValidatorForm dform = (DynaValidatorForm) form;
		Account accountInfo = new Account();
		dform.set("accountInfo", accountInfo);
	 ...
	 * @throws Exception
	 */
	public ActionForward loadAccount4Add(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
		...
		while(account.getUsrPostList().size() < 3)
		{
			account.getUsrPostList().add(new UsrPost());
		}
		
		account.setFlag(CommonService.NORMAL_FLAG);
	...
	public ActionForward loadAccount4Edit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (MyUtils.isBlank(accountId)) {
			errors.add("account id is not empty", new ActionMessage("errors.AccountIdNotEmpty"));
		}
	...
	private void prepareMetaData(HttpServletRequest request) {
		request.setAttribute("departmentList", commonService.getDepartmentList());
		request.setAttribute("educationList", commonService.getEducationList());
		request.setAttribute("postList", commonService.getPostList());
		request.setAttribute("politicalStatusList", commonService.getPoliticalstatusList());
		request.setAttribute("personStatusList", commonService.getPersonstatusList());
	}
	 ...
	 * @throws Exception
	 */
	public ActionForward addAccount(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
		...
		Account a = accountService.findAccountByName(account.getName());
		if( a == null )
		{
		...
		{
			errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("errors.AccountExist"));
	...
	public ActionForward enableAccount(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
	 ...
	 * @throws Exception
	 */
	public ActionForward removeAccount(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
			log.debug("Entering 'securityAction->loadPerson4Edit' method");
		}
		String accountId = request.getParameter("id");

		Account a = accountService.findAccountById(accountId);
		a.setFlag(CommonService.DELETE_FLAG);
	...
	public ActionForward cancelDeletedAccount(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
			log.debug("Entering 'securityAction->loadPerson4Edit' method");
		}
		String accountId = request.getParameter("id");
		...
		Account a = accountService.findAccountById(accountId);
		a.setFlag(CommonService.NORMAL_FLAG);
	 ...
	 * @throws Exception
	 */
	public ActionForward load4ChangePWD(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	 ...
	 * @throws Exception
	 */
	public ActionForward changeAccountPWD(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	 ...
	 * @throws Exception
	 */
	public ActionForward searchMenu(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	 ...
	 * @throws Exception
	 */
	public ActionForward loadMenu4Add(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	 ...
	 * @throws Exception
	 */
	public ActionForward loadMenu4Edit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	 ...
	 * @throws Exception
	 */
	public ActionForward addMenu(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
		...
		try {
			...
			if ((e.getMessage() != null) && (e.getMessage().indexOf("Duplicate entry") != -1)) {
				...
				errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("errors.existing.user", menu.getId(), menu.getName()));
				saveErrors(request, errors);
		...
		// add success messages
		if (menu.getId() == "") {
			messages.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("menu.added", menu.getId()));
			session.setAttribute(Globals.MESSAGE_KEY, messages);

			return mapping.getInputForward();
		} else {
			messages.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("menu.updated.byAdmin", menu.getId()));
			saveMessages(request, messages);
			return mapping.findForward("success");
		}
		// }
	 ...
	 * @throws Exception
	 */
	public ActionForward cancelMenu(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	...
	public ActionForward deleteMenu(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		messages.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("menu.deleted", menu.getName()));
	 ...
	 * @throws Exception
	 */
	public ActionForward getXMLMenuTree(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	 ...
	 * @throws Exception
	 */
	public ActionForward loadRole4GrantMenu(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	 ...
	 * @throws Exception
	 */
	public ActionForward loadRoleMenu4Grant(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	 ...
	 * @throws Exception
	 */
	public ActionForward loadAllMenu4Grant(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	 ...
	 * @throws Exception
	 */
	public ActionForward grantRoleMenus(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	 ...
	 * @throws Exception
	 */
	public ActionForward loadAccountRole4Grant(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
		...
		List<LabelValueBean> currentRole = new ArrayList<LabelValueBean>();
		List<LabelValueBean> availableRole = new ArrayList<LabelValueBean>();

		if (currentAccountRoles != null) {
			for (Iterator iterator = currentAccountRoles.iterator(); iterator.hasNext();) {
		...
		for (int i = 0; i < roles.size(); i++) {
			...
			if (!currentAccountRoles.contains(role)) {
				LabelValueBean lv = new LabelValueBean();
				lv.setLabel(role.getName());
				lv.setValue(role.getId());
	...
	public ActionForward grantAccountRole(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	...
	public ActionForward loadRole(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	...
	public ActionForward loadRole4Edit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
		...
		for (int i = 0; i < resources.size(); i++) {
			resourceList.put(((Resource) resources.get(i)).getId(), (Resource) resources.get(i));
		}
		...
		request.getSession(false).setAttribute("resources", resourceList.values());
		request.getSession(false).setAttribute("removeresources", role.getResources());
	...
	public ActionForward loadResource(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
	...
	public ActionForward addResource(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			errors.add("add resource", new ActionMessage("errors.ResourceAlreadyExist"));
		}
	...
	public ActionForward removeResource(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		if (log.isDebugEnabled()) {
		...
		try {
			...
			errors.add("remove resourc", new ActionMessage("errors.UnKnowError"));
		}
	...
	public final ActionForward searchSysOpLog(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
