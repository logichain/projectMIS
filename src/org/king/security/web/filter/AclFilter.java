...
//			
//			//添加方法级功能权限验证
//			String methodurl = url + "?method=" + request.getParameter("method");
//			if (!acl.hasRight(url, account) && !acl.hasRight(methodurl, account)) {
//			
...
//		}
	...
	private boolean isLogin(HttpServletRequest hreq) {
		...
		isLogin = (session != null) && !session.isNew()	&& (session.getAttribute("account") != null);
